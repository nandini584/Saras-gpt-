  ...
  return (
    <View style={{backgroundColor:"#F6F9F8"}}>
     ...
     <View style={{display:"flex", justifyContent:"center", alignItems:"center", backgroundColor:"#F6F9F8"}}>
      ...
      <Text style={{fontSize:16, marginTop:40, marginBottom:14 }}>You answered questions with <Text style={{color:"#06C295", fontWeight:700}}>60%</Text> acuracy</Text>
      <ProgressBar progress={progress} width={325} height={6} color="#06C295" borderRadius={20} backgroundColor="#BFF9EB" borderWidth={1} />
      <View>
