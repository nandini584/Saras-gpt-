  ...
  return (
    <View style={{backgroundColor:"#F6F9F8"}}>
     ...
     <View style={{display:"flex", justifyContent:"center", alignItems:"center", backgroundColor:"#F6F9F8"}}>
      ...
      <Text style={{fontSize:16, marginTop:40, marginBottom:14 }}>You answered questions with <Text style={{color:"#06C295", fontWeight:700}}>{Math.floor(route.params.points*100)}%</Text> acuracy</Text>
